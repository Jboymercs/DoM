...
public class WorldGenRandomRoom1 extends GenerateRandomRoom {
    public String V1 = "temple/four_way_1_1";
    public String V2 = "temple/four_way_1_2";

    public String V3 = "temple/four_way_1_3";
    private static final ResourceLocation LOOT = new ResourceLocation(Reference.MOD_ID, "ocean_temple");
    public String V5 = "temple/straight_1_1";
    public String V6 = "temple/straight_1_2";
    public String V7 = "temple/cross_1_1";
    public String V8 = "temple/cross_1_2";
    public String V4 = "temple/ruins_1_1";

    public String[] Options = {V1, V2, V3, V4, V5, V6, V7, V8};
