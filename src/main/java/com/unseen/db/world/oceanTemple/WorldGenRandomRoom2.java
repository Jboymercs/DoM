...
public class WorldGenRandomRoom2 extends GenerateRandomRoom{
    public String V1 = "temple/ruins_2_1";
    ...
    public String V3 = "temple/ruins_2_2";

    public String V5 = "temple/straight_2_1";
    public String V6 = "temple/straight_2_2";
    public String V7 = "temple/cross_2_1";
    public String V8 = "temple/cross_2_2";


    public String[] Options = {V1, V2, V3, V5, V6, V7, V8};

    public WorldGenRandomRoom2() {
        super("", -1);
