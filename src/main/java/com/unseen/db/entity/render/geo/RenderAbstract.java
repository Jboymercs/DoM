...
public abstract class RenderAbstract <T extends EntityLivingBase & IAnimatable> extends GeoLayerRenderer<T> {
    ...
    public RenderAbstract(GeoEntityRenderer<T> renderer, Function<T, ResourceLocation> funcGetCurrentTexture, Function<T, ResourceLocation> funcGetCurrentModel) {
        super(renderer);
