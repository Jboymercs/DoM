...
public class EntityHieroSpikeOp extends EntityModBase implements IAnimatable {
    ...
    public EntityHieroSpikeOp(World worldIn) {
        super(worldIn);
    ...
    public void onUpdate() {
        ...
        if(ticksExisted > 10 && ticksExisted < 20) {
            List<EntityLivingBase> targets = this.world.getEntitiesWithinAABB(EntityLivingBase.class, this.getEntityBoundingBox(), e -> !e.getIsInvulnerable() && (!(e instanceof EntityClaw || e instanceof EntityHeirophant || e instanceof EntityThrall || e instanceof EntityHieroSpike || e instanceof EntityJailCell || e instanceof EntityHieroSpikeOp)));
            if(!targets.isEmpty()) {
    ...
    public void registerControllers(AnimationData animationData) {
        animationData.addAnimationController(new AnimationController(this, "wave_spike_controller_op", 0, this::predicateIdle));
    }
